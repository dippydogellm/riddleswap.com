...
import '@/styles/polygon-wallet.css';
...
// Import the Polygon logo
const polygonLogoPath = '/images/chains/polygon-logo.png';
...
export default function PolygonWallet() {
  ...
  // Fetch Polygon balance using correct API endpoint
  const { data: balanceData, isLoading: balanceLoading, refetch: refetchBalance } = useQuery({
    queryKey: ['/api/wallets/polygon/balance', walletAddress],
    queryFn: async () => {
      const response = await fetch(`/api/wallets/polygon/balance/${walletAddress}`, {
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      toast({
        title: "Refreshed!",
        description: "Polygon wallet data updated",
        duration: 2000
      });
    } catch (error) {
      toast({
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-violet-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-black p-4">
        <div className="max-w-md mx-auto pt-20">
          <Card className="border-purple-200 dark:border-purple-800 shadow-xl">
            <CardHeader className="text-center pb-4">
              <div className="w-16 h-16 mx-auto mb-4 bg-purple-500 rounded-full flex items-center justify-center">
                <img src={polygonLogoPath} alt="Polygon" className="w-10 h-10" />
              </div>
              <CardTitle className="text-2xl font-bold text-purple-900 dark:text-purple-100">
                Polygon Wallet Access Required
              </CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Please log in to your Riddle Wallet to access your Polygon wallet
              </p>
  ...
  return (
    <div className="polygon-wallet-container min-h-screen bg-gradient-to-br from-purple-50 via-violet-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-black">
      {/* Header */}
      <div className="header-card bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-purple-200 dark:border-purple-800 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center">
                <img src={polygonLogoPath} alt="Polygon" className="w-5 h-5" />
              </div>
              <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card className="balance-card bg-gradient-to-br from-purple-500 via-violet-500 to-indigo-500 text-white border-0 shadow-xl">
              <CardHeader>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-white/20">
                    <p className="text-purple-100 text-sm mb-2">Wallet Address</p>
                    <div className="flex items-center gap-2">
                      ...
                      <Dialog>
                        ...
                        <DialogContent className="max-w-sm">
                          <DialogHeader>
                            <DialogTitle>Polygon Wallet QR Code</DialogTitle>
                          </DialogHeader>
