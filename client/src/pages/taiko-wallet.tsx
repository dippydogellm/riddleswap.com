...
import '@/styles/taiko-wallet.css';
...
export default function TaikoWallet() {
  ...
  // Fetch Taiko balance using direct endpoint
  const { data: balanceData, isLoading, refetch, error } = useQuery({
    queryKey: ['/api/wallets/taiko/balance', walletAddress],
    queryFn: async () => {
      const response = await fetch(`/api/wallets/taiko/balance/${walletAddress}`, {
  ...
  const handleCopyAddress = () => {
    if (balanceData?.address) {
      ...
      toast({
        ...
        description: "Taiko address copied to clipboard"
      });
  ...
  const handleRefresh = () => {
    ...
    toast({
      title: "Refreshing",
      description: "Updating Taiko wallet data..."
    });
  };
      ...
      <div className="min-h-screen flex items-center justify-center">
        <Card className="max-w-md">
          <CardContent className="p-6 text-center">
            <h2 className="text-xl font-bold mb-4">Taiko Wallet Error</h2>
  ...
  return (
    <div className="taiko-wallet-container min-h-screen bg-gradient-to-b from-pink-50 to-pink-100 dark:from-gray-900 dark:to-black py-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold flex items-center gap-2">
                <div className="w-10 h-10 bg-pink-600 rounded-full flex items-center justify-center text-white text-xl">
                  🎗️
                </div>
                Taiko Wallet
              </h1>
              <p className="text-gray-600 dark:text-gray-400">Based Rollup Layer 2</p>
            </div>
          </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-sm">Transactions will appear here once you start using your Taiko wallet</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-sm">You'll be able to send ETH on Taiko network</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
