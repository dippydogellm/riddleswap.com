...
import '@/styles/fantom-wallet.css';
...
// Import the Fantom logo
const fantomLogoPath = '/images/chains/fantom-logo.png';
...
export default function FantomWallet() {
  ...
  // Fetch Fantom balance using ETH endpoints (EVM compatible)
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      toast({
        title: "Refreshed!",
        description: "Fantom wallet data updated",
        duration: 2000
      });
    } catch (error) {
      toast({
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-cyan-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-black p-4">
        <div className="max-w-md mx-auto pt-20">
          <Card className="border-indigo-200 dark:border-indigo-800 shadow-xl">
            <CardHeader className="text-center pb-4">
              <div className="w-16 h-16 mx-auto mb-4 bg-indigo-500 rounded-full flex items-center justify-center">
                <img src={fantomLogoPath} alt="Fantom" className="w-10 h-10" />
              </div>
              <CardTitle className="text-2xl font-bold text-indigo-900 dark:text-indigo-100">
                Fantom Wallet Access Required
              </CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Please log in to your Riddle Wallet to access your Fantom wallet
              </p>
  ...
  return (
    <div className="fantom-wallet-container min-h-screen bg-gradient-to-br from-indigo-50 via-cyan-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-black">
      {/* Header */}
      <div className="header-card bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-indigo-200 dark:border-indigo-800 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-indigo-500 rounded-full flex items-center justify-center">
                <img src={fantomLogoPath} alt="Fantom" className="w-5 h-5" />
              </div>
              <div>
                <h1 className="text-xl font-bold text-indigo-900 dark:text-indigo-100">
                  Fantom Wallet
                </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card className="balance-card bg-gradient-to-br from-indigo-500 via-cyan-500 to-blue-500 text-white border-0 shadow-xl">
              <CardHeader>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-white/20">
                    <p className="text-indigo-100 text-sm mb-2">Wallet Address</p>
                    <div className="flex items-center gap-2">
                      ...
                      <Dialog>
                        ...
                        <DialogContent className="max-w-sm">
                          <DialogHeader>
                            <DialogTitle>Fantom Wallet QR Code</DialogTitle>
                          </DialogHeader>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium">Fantom Opera</span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium">FTM</span>
                  </div>
                  <div className="flex justify-between items-center">
