...
import { z } from 'zod';
import { ArrowLeft, Download, Search, FileText, Database, CheckCircle2, Loader2, AlertCircle, Coins } from 'lucide-react';
...
const TokenSnapshot = () => {
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-slate-600 dark:text-slate-400">Loading Token Snapshot...</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const form = useForm<TokenSnapshotFormData>({
    resolver: zodResolver(tokenSnapshotSchema),
    defaultValues: {
      chain: '',
      target_contract: '',
      block_number: '',
  ...
  const createSnapshotMutation = useMutation({
    mutationFn: async (data: TokenSnapshotFormData) => {
    ...
    onSuccess: (result) => {
      ...
      toast({
        ...
        description: `Successfully captured ${result.total_holders || 0} token holders.`,
      });
    },
    onError: (error) => {
      ...
      toast({
        ...
        description: error.message || 'Failed to create token snapshot. Please try again.',
        variant: 'destructive'
      });
    }
  });

  const onSubmit = (data: TokenSnapshotFormData) => {
  ...
  return (
    <div className="snapshot-tool token-snapshot">
      {/* Header */}
      <div className="snapshot-header">
        <div className="header-content">
          ...
          <div className="header-info">
            ...
            <div>
              <h1 className="header-title">Token Snapshot</h1>
              <p className="header-subtitle">Capture token holder balances for governance and rewards</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="snapshot-content">
        <div className="snapshot-grid">
          ...
          <Card className="snapshot-form-card">
            <CardHeader>
              ...
              <CardDescription>
                Configure your token snapshot parameters
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Only include holders with balance above this amount
                        </p>
                      </FormItem>
                    )}
                  />
                ...
                <CardContent>
                  {snapshotStatus === 'processing' && (
                    <div className="status-content">
                      <p>Processing token holder data...</p>
                    ...
                    <div className="status-content">
                      <div className="result-stats">
                        ...
                        <div className="stat-item">
                          ...
                          <span className="stat-value">{snapshotResult.total_supply || 'N/A'}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-2">
                        ...
                        <CSVExport
                          ...
                          filename={`token_snapshot_${form.watch('target_contract')}`}
                          headers={['address', 'balance', 'percentage']}
        ...
        <Card className="recent-snapshots">
          <CardHeader>
            <CardTitle>Recent Token Snapshots</CardTitle>
            <CardDescription>
              Your recently created token holder snapshots
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="snapshots-list">
              <div className="snapshot-item">
                <div className="snapshot-info">
                  <div className="snapshot-name">USDC Token</div>
                  <div className="snapshot-meta">
                    <Badge variant="outline">Ethereum</Badge>
                    <span>1,234,567 holders</span>
              ...
              <div className="snapshot-item">
                <div className="snapshot-info">
                  <div className="snapshot-name">SHIB Token</div>
                  <div className="snapshot-meta">
                    <Badge variant="outline">Ethereum</Badge>
                    <span>567,890 holders</span>
              ...
              <div className="snapshot-item">
                <div className="snapshot-info">
                  <div className="snapshot-name">MATIC Token</div>
                  <div className="snapshot-meta">
                    <Badge variant="outline">Ethereum</Badge>
                    <span>234,567 holders</span>
