...
import '@/styles/soneium-wallet.css';
...
export default function SoneiumWallet() {
  ...
  // Fetch Soneium balance using direct endpoint
  const { data: balanceData, isLoading, refetch, error } = useQuery({
    queryKey: ['/api/wallets/soneium/balance', walletAddress],
    queryFn: async () => {
      const response = await fetch(`/api/wallets/soneium/balance/${walletAddress}`, {
  ...
  const handleCopyAddress = () => {
    if (balanceData?.address) {
      ...
      toast({
        ...
        description: "Soneium address copied to clipboard"
      });
  ...
  const handleRefresh = () => {
    ...
    toast({
      title: "Refreshing",
      description: "Updating Soneium wallet data..."
    });
  };
      ...
      <div className="min-h-screen flex items-center justify-center">
        <Card className="max-w-md">
          <CardContent className="p-6 text-center">
            <h2 className="text-xl font-bold mb-4">Soneium Wallet Error</h2>
  ...
  return (
    <div className="soneium-wallet-container min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 dark:from-gray-900 dark:to-black py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">Sony Layer 2</p>
            </div>
          </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-sm">Transactions will appear here once you start using your Soneium wallet</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-sm">You'll be able to send ETH on Soneium network</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
